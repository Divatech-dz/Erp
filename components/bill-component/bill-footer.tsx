    ...
    <div className="flex items-center justify-center flex-wrap gap-4  p-6">
          ...
          <div className="w-full  bg-white rounded-lg shadow-md overflow-hidden">
            <div className="p-6">
              <div className="flex justify-between items-center border-b pb-4 mb-4">
                <p className="text-gray-700 font-medium">Total HT [Sans Livraison]</p>
                <span className="text-gray-900 font-semibold">0,00 DZ</span>
              </div>
              <div className="flex justify-between items-center border-b pb-4 mb-4">
                <p className="text-gray-700 font-medium">Remise HT [Sans Livraison] </p>
                <span className="text-gray-900 font-semibold">0,00 DZ</span>
              </div>
              <div className="flex justify-between items-center border-b pb-4 mb-4">
                <p className="text-gray-700 font-medium">Frais Livraison [ INTERNE ]</p>
                <span className="text-gray-900 font-semibold">0,00 DZ</span>
              </div>
          ...
          <div className="w-full  bg-white rounded-lg  overflow-hidden">
            <div className=" flex justify-end items-end gap-2">
              <Button className="border-bankGradient bg-black-1 rounded-lg hover:bg-gray-200 active:bg-gray-300 text-white">Valider le Bon & imprime</Button>
            </div>
          </div>
        </div>
  )
